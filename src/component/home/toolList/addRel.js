                ...
                >
                    <div>
                        ...
                        <p className="text-body-title">
                            3、当前可编辑图层：“面状标识物”、“交通信号灯”、“交通标志牌”
                        </p>
                        <p className="text-body-content">
                            (1). 一个当前编辑图层的obj要素 + 一个或多个车道中心线
                            <br />
                            例如：一个“面状标识物” +
                            多个“车道中心线”——可建立多对【车道中心线&面状标识关联关系】
                            <br />
                            (2). 一个当前编辑图层的obj要素 + 一个“交叉口”
                        </p>
                        <p className="text-body-title">4、当前可编辑图层：“车道线”</p>
                        <p className="text-body-content">
                            (1). 一个道路边界标识为“道路边界”的车道线 + 一个道路参考线
                            <br />
                            (2). 一个道路边界标识为“道路边界”的车道线 +
                            一个道路边界标识为“道路边界”的车道线
                            <br />
                            (3). 一个车道线 + 多个虚线框—可建立多对【虚线框&车道线关联关系】
                            <br />
                            (4). 一个车道线 + 一个“交叉口”
                        </p>
                        <p className="text-body-title">
                            5、当前可编辑图层：“地面导向箭头”/“文字符号”
                        </p>
                        <p className="text-body-content">
                            (1). 一个地面导向箭头/文字符号 + 一个车道中心线
                            <br />
                            (2). 一个地面导向箭头/文字符号 + 一个“交叉口”
                        </p>
                        <p className="text-body-title">6、当前可编辑图层：“交叉口”</p>
                        <p className="text-body-content">
                            (1). 一个交叉口+ 一个或多个要素（包括人行横道、车道线、箭头等）
                        </p>
                        <p className="text-body-title">7、当前可编辑图层：“杆”</p>
                        <p className="text-body-content">
                            (1). 一个杆+ 一个参考线
                            <br />
                            (2). 一个杆 + 一个“交叉口”
                        </p>
                        <p className="text-body-title">8、当前可编辑图层：“虚线框”</p>
                        <p className="text-body-content">(1). 一个虚线框+ 一个车道线</p>
                        <p className="text-body-title">9、当前可编辑图层：“停止线几何层”</p>
                        <p className="text-body-content">
                            (1). 一个“停止线几何层”+ 一个“停止线逻辑层”
                        </p>
                        <p className="text-body-title">10、当前可编辑图层：“停止线逻辑层”</p>
                        <p className="text-body-content">
                            (1). 一个“停止线逻辑层”+ 一个/多个“停止线几何层”
                            <br />
                            (2). 一个“停止线逻辑层”+
                            一个/多个“中心线”——可建立多对【车道中心线&停止位置关联关系】
                            <br />
                            (3). 一个“停止线逻辑层” + 一个“交叉口”
                        </p>
                    </div>
