...
class VizComponentXGIS extends React.Component {
    ...
    init = async () => {
        ...
        const { TaskStore } = this.props;
        // let urls;
        // const filePath = "http://10.43.75.119/precomp_tasks/2042463/03_STD_ED_DATA/0303_STD_ED_DES/";

        // // 加载矢量图层
        // const file = "/ADMAP/COMPILE_STD2RMD/PRECOMP_TASKS/2042464/03_STD_ED_DATA/0303_STD_ED_DES/";// filePathTitleUrl(activeTask);
        ...
        // await this.installVector(vectors);
        //设置画面缩放比例
        this.setMapScale();
