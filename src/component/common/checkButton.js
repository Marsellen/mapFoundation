...
class CheckButton extends React.Component {
        ...
        return (
            <span id="check-button" className="check-button">
                ...
                <ToolIcon
                    ...
                    popover={{
                        overlayClassName: visible ? 'check-button-popover' : 'hide-popover',
    ...
    renderContent = () => {
        let selectedKey = this.state.option.icon || this.state.defaultOption.key;
