...
import 'src/asset/less/ad-color-select.less';
...
class AdColorSelect extends React.Component {
    ...
    dropdownRender = menu => {
        ...
        return (
            <div>
                {menu}
                <div className="define-color-box" onMouseDown={e => e.preventDefault()}>
                    <div
    ...
    render() {
        ...
        return (
            ...
            <div className={`ad-color-select-box ${visible ? 'set-z-index' : ''}`}>
                <Select
                    style={{ width }}
                    ...
                    value={currentValue}
                    labelInValue={true}
                    dropdownClassName={`ad-color-select-dropdown ${visible ? 'hide' : ''} ${
                        this.margin
                    }`}
