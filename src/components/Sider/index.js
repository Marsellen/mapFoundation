...
class Sider extends React.Component {
    ...
    render() {
        ...
        return (
            <div style={styles.sider}>
                <SiderBar>
                    {menus.map(record => <SiderItem key={record.type} record={record} activeItem={activeItem} clickAction={this.clickSiderItem} />)}
                </SiderBar>
    ...
    clickSiderItem = (item) => {
        ...
        let showContent = !this.state.showContent || type == item.type
