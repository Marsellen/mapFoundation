    ...
    AD_TS_CONTENT_SIGN_TYPE: [
        ...
        [
            { value: 111, label: '注意行人', icon: 'zhuyixingren' },
            {
                value: 140,
                label: '注意合流–左侧合流',
                icon: 'zhuyiheliuzuoceheliu'
            },
            {
                value: 147,
                label: '注意合流–右侧合流',
                icon: 'zhuyiheliuyouceheliu'
            },
            ...
            { value: 148, label: '其他警告标志', icon: 'qitajinggaotishi' }
        ],
        ...
        [
            ...
            { value: 201, label: '停车让行', icon: 'tingcherangxing' },
            {
                value: 207,
                label: '禁止向左转弯',
                icon: 'jinzhixiangzuozhuanwan'
            },
            {
                value: 208,
                label: '禁止向右转弯',
                icon: 'jinzhixiangyouzhuanwan'
            },
            ...
            { value: 213, label: '禁止掉头', icon: 'plus' },
            {
                value: 206,
                label: '禁止机动车驶入',
                icon: 'jinzhijidongcheshiru'
            },
            { value: 233, label: '其他禁令标志', icon: 'qitajinlingbiaozhi' },
        ...
        [
            { value: 317, label: '人行横道', icon: 'plus' },
            {
                value: 328,
                label: '车道行驶方向--其他',
                icon: 'chedaoxingshifangxiangqita'
            },
        ...
        [
            ...
            { value: 600, label: '动态限速标志', icon: 'plus' },
            { value: 500, label: '其他标志牌', icon: 'plus' },
        ...
        [
            ...
            { value: 139, label: '避险车辆', icon: 'plus' },
        ...
        [
            ...
            { value: 305, label: '直行和向右转弯', icon: 'plus' },
            { value: 306, label: '向左和向右转弯', icon: 'plus' },
