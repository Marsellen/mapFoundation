export default {
    ...
    styles: {
        ...
        AD_LANEDIVIDER_RD_LINE: [
            { value: 0, label: '未定义', style: { color: 'rgb(255,255,255)' } },
            {
                value: 1,
                label: '道路参考线',
        ...
        AD_LANEATTRPOINT_TYPE: [
            {
                value: 0,
                label: '未定义',
                style: { color: 'rgb(102,255,102)', radius: 0.015 }
            },
            {
                value: 1,
                label: '道路左侧出口',
        ...
        AD_MAP_QC_TYPE: [
            {
                value: 0,
                label: '未定义',
                style: { color: 'rgb(235,45,19)', radius: 0.03 }
            }
        ],
        AD_POLE_TYPE: [
            {
                value: 0,
                label: '',
                style: { color: 'rgb(32,52,240)', radius: 0.015 }
            }
        ]
    }
};
