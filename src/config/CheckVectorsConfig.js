const biaojituceng = require('../assets/img/biaojituceng.png'); //质检符号模式
        ...
        vectorStyle: {
            TYPE: [
                ...
                },
                {
                    value: 2,
                    label: '虚拟道路参考线',
                    style: { color: 'rgb(235,45,19)', dashSize: 0.5, gapSize: 0.5, linewidth: 1 }
                }
            ]
        },
        pointFLStyle: {
        ...
        arrowStyle: {
            TYPE: [
                ...
                },
                {
                    value: 2,
                    label: '虚拟道路参考线',
                    style: { color: 'rgb(235,45,19)', linewidth: 1 }
                }
            ]
        }
    },
        ...
        vectorStyle: {
            TYPE: [
                ...
                },
                {
                    value: 2,
                    label: '路口车道',
                    style: { color: 'rgb(255,237,37)', dashSize: 0.5, gapSize: 0.5, linewidth: 1 }
                },
                {
                    value: 3,
                    label: '应急车道',
            ...
            TYPE: [
                {
                    value: 0,
                    label: '未定义',
                    style: { color: 'rgb(250,220,70)', linewidth: 1 }
                },
                {
                    value: 1,
                    label: '直行箭头',
            ...
            TYPE: [
                {
                    value: 0,
                    label: '未定义',
                    style: { color: 'rgb(231,120,0)', linewidth: 1 }
                },
                {
                    value: 1,
                    label: '普通交通信号灯',
